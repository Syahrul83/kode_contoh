    ...
    <main class="mt-3">
        ...
        <div id="myCarousel" class="carousel slide mb-6 mt-4" data-bs-ride="carousel">
            <div class="carousel-indicators">
                ...
                <button type="button" data-bs-target="#myCarousel" data-bs-slide-to="{{ $index }}" class="{{ $index == 0 ? 'active' : '' }}" aria-current="{{ $index == 0 ? 'true' : 'false' }}" aria-label="Slide {{ $index + 1 }}">
                </button>
                @endforeach
            </div>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                    <img class="bd-placeholder-img d-block w-100" src="{{ asset($item->image) }}" alt="gambar">
                    <div class="container">
                        <div class="carousel-caption text-start">
                            <h1>{{ $item->nama }}</h1>
                            <p class="opacity-75">Some representative placeholder content for the slide.</p>
